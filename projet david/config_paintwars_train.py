...
def initialize_robots(arena_size=-1, particle_box=-1): # particle_box: size of the robot enclosed in a square
    ...
    robots = []
    for i in range(4):
        robots.append(genetique_paintwars.Robot_player(x_init_pos[0], arena_size//2-16+i*8, orientation_champion, team="A"))
    for i in range(4):
        robots.append(genetique_paintwars.Robot_player(x_init_pos[1], arena_size//2-16+i*8, orientation_challenger, team="B"))
    return robots